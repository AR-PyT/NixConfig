    ...
    extraConfig =
      concatStrings [
        ''
          ...
          windowrule = float, swayimg|vlc|Viewnior|pavucontrol|zoom|mpv|nm-connection-editor|blueman-manager
          windowrule = float, nwg-look|qt5ct|mpv
          windowrule = float, zoom

          windowrule = opacity 1.0 0.8, class:^(kitty)$

          windowrule = opacity 0.95 0.8, class:^(firefox)$
